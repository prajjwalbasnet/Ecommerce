...
const About = () => {
  return (
    <div>
        ...
        <div className='border-t border-gray-300 text-2xl text-center pt-8'>
        ...
        <div className='flex flex-col md:flex-row text-sm mb-20'>
            <div className='flex flex-col border border-gray-300 py-8 sm:py-20 px-10 md:px-16 gap-5'>
                <b>Quality Assurance:</b>
                <p>We meticulously select and vet each product to ensure it meets our stringent
                        quality standards.</p>
            </div>
            <div className='flex flex-col border border-gray-300 py-8 sm:py-20 px-10 md:px-16 gap-5'>
                <b>Convenience:</b>
                <p>With our user-friendly interface and hassle-free ordering process, shopping
                        has never been easier.</p>
            </div>
            <div className='flex flex-col border border-gray-300 py-8 sm:py-20 px-10 md:px-16 gap-5'>
                <b>Exceptional Customer Service:</b>
                <p>Our team of dedicated professionals is here to assist you the way, ensuring
